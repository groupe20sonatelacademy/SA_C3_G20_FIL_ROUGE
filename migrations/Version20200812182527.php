 ...
 */
final class Version20200812182527 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE groupe (id INT AUTO_INCREMENT NOT NULL, formateur_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, date_creation VARCHAR(255) NOT NULL, INDEX IDX_4B98C21155D8F51 (formateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
