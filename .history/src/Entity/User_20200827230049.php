...

{
     ...
     * @Groups({"user:read","formateur:read","apprenant:read","cm:red","profilsortieApp:read","profilsortie:read","chat:read"})
     */
    protected $username;
     ...
     * @Groups({"user:read","formateur:read","apprenant:read","cm:red","profilsortieApp:read","profilsortie:read"})
     */
    protected $genre;
     ...
     * @ApiSubresource()
     * @Groups({"user:read","formateur:read","apprenant:read","cm:red"})
     */
    protected $profil;
