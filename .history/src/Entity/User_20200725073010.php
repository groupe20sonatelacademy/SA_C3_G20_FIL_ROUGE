 ...
 *       },
 *  iri="https://127.0.0.1:8000/api/users",
 *     normalizationContext={
 *         "groups"={"media_user_read"}
 *     },
 ...
 *             "validation_groups"={"Default", "media_user_create"},
 *             "openapi_context"={
 *                 "requestBody"={
 *                     "content"={
 *                         "multipart/form-data"={
...

{
     ...
     * @assert\NotNull(media_user_create)
     * @Vich\UploadableField(mapping="media_user", fileNameProperty="filePath")
     */
    private $photo;
     ...
     * )
     * @Groups({"media_user_read","Profil_read"})
     */
    private $genre;
