 ...
 *              "security"="(is_granted('ROLE_Formateur') || is_granted('ROLE_CM'))",
 ...
 *                   "method" = "GET",
 *                   "requirements"={"id"="\d+"},
 *                   "path" ="/formateurs/promos/{id_promo}/groupes/{id_groupe}/briefs",
 ...
 *                   "route_security"="(is_granted('ROLE_Apprenant') || is_granted('ROLE_CM'))",
 *                   "route_security_message"="Vous n'avez pas access à cette Ressource"  
 *                },
 * 
 *    },
...
class Brief
{
     ...
     * @groups({"brief:read","brouillon:read","valide:read" ,"promo:read","briefGroupe:read","briefApprenant:read"})
     */
    private $langue;
     ...
     * @groups({"promo:read","briefGroupe:read","briefApprenant:read"})
     */
    private $formateur;
     ...
     * @groups({"groupe:read","briefApprenant:read","promo:read","briefGroupe:read"})
     */
