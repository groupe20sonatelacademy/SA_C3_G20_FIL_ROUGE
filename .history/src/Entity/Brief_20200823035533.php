 ...
 *              "route_name"="Afficher_brief"
 *            },  
 *       
 *          "Lister_brief_groupe_promo"={
 *                   "method" = "GET",
 *                   "requirements"={"id"="\d+"},
 *                   "path" ="/formateurs/promos/{id_promo<\id+>}/groupes/{id_groupe<\id+>}/briefs",
 *                   "route_name"="Afficher_brief_groupe_promo",
 *                   "security"="is_granted('ROLE_Formateur')",
 *                   "security_message"="Vous n'avez pas access à cette Ressource"
 *                },  
 *          "Lister_brief_promo"={
 *                   "method" = "GET",
 *                   "requirements"={"id"="\d+"},
 *                   "path" ="/formateurs/promos/{id_promo<\id+>}/groubriefs",
 *                   "route_name"="Afficher_brief_promo",
 *                   "security"="is_granted('ROLE_Formateur')",
 *                   "security_message"="Vous n'avez pas access à cette Ressource"
 *                },  
 *   
