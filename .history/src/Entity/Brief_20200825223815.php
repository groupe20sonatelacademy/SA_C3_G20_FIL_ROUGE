...
class Brief
{
     ...
     * @groups({"brief:read","brouillon:read","valide:read","promo:read","briefGroupe:read","briefApprenant:read","ressource:read"})
     */
    private $ressource;
     ...
     * @groups({"groupe:read","briefApprenant:read","promo:read"})
     */
