...
class Brief
{
     ...
     * @groups({"brief:read","brouillon:read","valide:read" ,"promo:read","brief_groupe:read"})
     */
    private $langue;
     ...
     * @groups({"promo:read","brief_groupe:read"})
     */
    private $formateur;
     ...
     * @groups({"brief:read","brouillon:read","valide:read","promo:read","briefroupe:read"})
     */
    private $nivaux;
     ...
     * @groups({"brief:read", "promo:read","briefGroupe:read"})
     */
    private $promoBriefs;
