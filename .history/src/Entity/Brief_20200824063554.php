 ...
 *                },
 *         "getPromoBriefAtApprenant"={
 *                   "method" = "GET",
 *                  "requirements"={"id"="\d+"},
 *                   "path" ="/apprenants/promos/{id}/briefs",
 *                   "route_name"="getPromoBriefAtApprenant"
 *                },
 * 
 *    },
 * 
...
class Brief
{
     ...
     * @groups({"brief:read","brouillon:read","valide:read" ,"promo:read","briefGroupe:read",eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.eyJpYXQiOjE1OTgyNDM2ODYsImV4cCI6MTU5ODI0NzI4Niwicm9sZXMiOlsiUk9MRV9Gb3JtYXRldXIiXSwidXNlcm5hbWUiOiJpbmVzLnJpb3UifQ.hp42qVEaL3mdq7VL9PqQjRpx97-bWFcBe8VLEf20-p6TpGp0TH7RXbVLWw0jtVwh6uK1FyZfEUWuJwlH6FMiHoxrbugGdGknIdbU5J7SARBGcCL7cFar031CTh_ULbXWyNYFxt31wwpZkfJWN4erqvpLkrhJTDuUsEdTgU1OvSa_r7BHW47u6yQYU6naWEremvuhkUCNGDseJOBVbst_KvEQOkuWaZ0MB9-J1xKI7UBQKjkGoikmXr_IgjOOa074JE7H9w2gneGq1nu6FXlU8z-p_hIwvPVO83M1fzxge8GBGLE7WKFL8U2Wk0-VgqYJFFandoFvo-pofuft9GqylVTX-r93zZnP-ZgbDOxqkZVgLmPHquulRRshhdYzbBtuiCQI_N2M0zqCVtsqx9fdKU5RJ-c_h-RrMun0-5DBZXiPnahUGYTRLfYUC1MWdMO-HQRXWJccm-dx_yXg4x8sCQISOY3Mh5YuUIjMDOzJuOSqU7r_4aQ86tLC4jof71hifJdpG58LTAAf0MMbek3maqL-nmdiGk5zpGXCSn9EqfHfnmpJwQSHQjW0V_5dPgKB6hkUu_p0m3LSWWJgLXm1Xt6SK7hOOJcmZwIRwERcmJKht5mxckrN5tx8upKK2RFuZwnfDyZbaIzjKeKY_XSP-A7alRtjObOeOWTDW2nQTAc})
     */
    private $langue;
