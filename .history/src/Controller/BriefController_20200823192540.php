...
class BriefController extends AbstractController
{
    ...
    /**
     * @Route(
     *      name="getBriefInBrief",               
     *         path = "/api/formateurs/promos/{id}/briefs/{id}",
     *         methods={"GET"},
     *          
     * )
     * 
     */
    public function getBriefInBrief(BriefRepository $briefRepository, PromoRepository $promoRepository, $id)
    {
        $briefs = [];
        $promo = $promoRepository->findOneBy(["id" => $id]);
        if ($promo) {
