...
class ProfilsortieController extends AbstractController
{
     ...
     *     )
     */
    public function getProfilsortieAndApprenant(int $id,ProfilsortieRepository $profilsortieRepository,ApprenantRepository)
    {
$profils=[];
        ...
        if ($profilsorties) {
            foreach ($profilsorties  as $value) {
                $profils[]=$apprenantRepository->find($value)
            }
