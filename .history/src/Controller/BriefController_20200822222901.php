...
class BriefController extends AbstractController
{
     ...
     * 
     */
    public function ListerBriefPromoGroupe( int $id, BriefRepository $briefRepository,
    PromoRepository $promoRepository, GroupeRepository $groupeRepository){

$briefpromo= $briefRepository->findBy($id);
