...
class BriefController extends AbstractController
{
     ...
     * 
     */
    public function getPromoBriefAtApprenant(BriefRepository $briefRepository, PromoRepository $promoRepository, $id)
    {
        $brief = [];
        $promo = $promoRepository->findOneBy(["id" => $id]);
        if ($promo) {
        ...
        return $this->json(["message" => " cette ressource n'existes", 404]);
    }
