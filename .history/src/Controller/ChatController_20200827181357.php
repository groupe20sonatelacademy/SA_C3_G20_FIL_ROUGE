...
class ChatController extends AbstractController
{
    ...
    public function getChats(  UserRepository $userRepository, PromoRepository $promoRepository ,ChatRepository $chatRepository)
     {


     $chat=$chatRepository->findAll();       
 return $this->json($chat,200,[], ["groups" => ["Chat:read"]]);
