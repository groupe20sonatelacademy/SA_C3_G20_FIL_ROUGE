                 ...
                 //dd($apprenants);   
                  ...
                  foreach($apprenants as  $profils) {
                      ...
                      if($profils->getApprenant()){
                          $apprenant= $profils->getGroupe();
                       //  dd($apprenant); il affiche promo et groupe
                         foreach ($apprenant as  $value) {
                             if($value->getProfilsortie()=="profilsortie"){
                                 $groupe= $value->getProfilsortie();
                            dd($groupe); 
                             }
                         }

                    return $this->json($profils, 200, [], ["groups" => ["profilsApprenant:read"]]);
                      }
                  }
