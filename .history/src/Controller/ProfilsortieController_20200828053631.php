            ...
            foreach ($groupe as  $groupes) {
                ...
                foreach ($apprenants as $value) {
                    if ($value->getProfilsortie() ) {
                        $TabProfil[] = $value->getProfilsortie();
                       // return $this->json($TabProfil);uuuu
                        foreach ($TabProfil as $values){

                            if ($values == $profils){
$idProfils=$values->getApprenantAtPromo();
//return $this->json($idProfils);nnnn
                               // return $this->json($TabProfil, 200);mmmm
                            }
                        }
