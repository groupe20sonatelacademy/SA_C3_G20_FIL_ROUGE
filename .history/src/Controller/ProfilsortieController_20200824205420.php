...
//dd($profil);
     ...
     *     )
     */
    public function getProfilsortieAtPromo(int $id, ProfilsortieRepository $profilsortieRepository, PromoRepository $apprenantRepository)
    {

        $promo = $profilsortieRepository->findOneBy(["id" => $id]);
