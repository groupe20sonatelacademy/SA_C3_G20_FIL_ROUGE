...
// Ajout dun fils de discussion et commentaire dans un livrable partiel
    ...
    public function addCommentaire(int $id,LivrablePartielRepository $livrablePartielRepository,
        ...
        LivrablePartielApprenantRepository $livrablePartielApprenantRepository
        )
    {
...
$fildiscussion=$fildiscussionRepository->findBy(["livrablePartielApprenant"=>$LivrablePartielApprenant->getId()])
    }
}
