...
class PromoController extends AbstractController
{
  ...
  /*  public function addFormateurByUsername(string $username, int $id, UserRepository $userRepository, EntityManagerInterface $manager, Request $request)
    ...
    public function addPromo(Request $request, \Swift_Mailer $mailer, ApprenantRepository $apprenant_repo, value $value, Message)
    {
//debut action
...
$message=(new\Swift_Message('Selection SonatelAccademy '))
