...
class BriefController extends AbstractController
{
     ...
     * @Route(
     * 
     *         name="Afficher_brief_promo",               
     *         path = "/api/formateurs/promos/{id}/briefs",
     *         requirements={"id"="\d+"},
     *         methods={"GET"},
     *         defaults={ 
     *            "controller"="App/BriefController::ListerBriefPromo",
     *            "api_resource_class"= Brief::class,
     *            "api_collection_operation_name"="Lister_Brief_promo"
     *       },
     * )
     * 
     */

    public function ListerBriefBpromo(int $id , BriefRepository $briefRepository ,PromoRepository $promoRepository){
            $promo = $promoRepository->find($id_);
    }
